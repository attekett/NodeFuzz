...
config.sample_dir='/home/attekett/samples/'
...
config.init=function(){
	...
	if(process.platform=='win32'){
		...
		config.launchCommand='/home/attekett/Downloads/chrome/chrome'
		config.browserArgs = ['--user-data-dir=/tmp/'+config.pid+'/chrome-prof','--no-sandbox','--disable-translate','--incognito', '--new-window','--no-default-browser-check','--allow-file-access-from-files', '--no-first-run' ,'--no-process-singleton-dialog' ,'http://127.0.0.1:'+config.port]
